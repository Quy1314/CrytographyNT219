...
BEGIN {
    ...
    require 'C:/Documentss/Cryptography/LAB05_BTTL/msvc/openssl-3.3.2/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'C:/Documentss/Cryptography/LAB05_BTTL/msvc/openssl-3.3.2/test/fips-and-base.cnf';
    shift;
